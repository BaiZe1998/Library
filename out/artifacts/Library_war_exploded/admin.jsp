		...
		<table class="table" cellspacing="0">
			...
			<c:forEach items="${list}" var="borrow">
				<tr>
					...
					<td>
						<a href="/admin?method=handle&borrowId=${borrow.id}&state=1&page=${currentPage}">同意</a>
						<a href="/admin?method=handle&borrowId=${borrow.id}&state=2&page=${currentPage}">拒绝</a>
					</td>
				</tr>
			</c:forEach>
